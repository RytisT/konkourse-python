...
def accountsettings_security(request):
    if request.user.is_authenticated():
        # returns the instance of the user profile model associated with that User and assigns it to object 'p'
        ...
        if request.method == 'POST':  # if the form has been submitted
            ...
            if form.is_valid():  # if the form is valid
                ...
                # send user to settings page with updated info
                return render(request, 'website/accountsettings_security.html', {'form': form, })
            else:
                return render(request,
                              'website/accountsettings_security.html',
                              {'form': form,
                               })  # return user to settings page
        else:  # if the form is not being submitted
            form = EmailPreferencesForm(instance=user_profile)
            # show user settings with most recent info
            return render(request, 'website/accountsettings_security.html', {'form': form, })
