  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year span1' name='birth[year]'></select>"),
          $month = $("<select class='birth-month span2' name='birth[month]'></select>"),
          $day = $("<select class='birth-day span1' name='birth[day]'></select>");
